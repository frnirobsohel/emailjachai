...
// IsValidMailboxSyntax is the shared gate for public, single, bulk accept, and SMTP engines.
// Practical ASCII mailbox form — not full RFC 5322 (no quoted locals / comments).
// Stricter than bulk's old "@ + len>=5" so garbage is not charged or SMTP-probed.
