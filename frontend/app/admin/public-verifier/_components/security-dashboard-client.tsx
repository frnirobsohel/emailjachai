        ...
        <div className="flex-1 space-y-6">
            ...
            <Card className="border-[#0b1f1c]/10 shadow-none bg-white/90">
                <CardHeader className="bg-[#f0f4f2]/60 border-b border-[#0b1f1c]/8">
                    <CardTitle className="text-lg font-semibold text-[#0b1f1c]">Frontend Pricing Packages</CardTitle>
                    <CardDescription>Select which packages should be visible on the public landing page.</CardDescription>
                </CardHeader>
                <CardContent className="pt-6">
                    <div className="grid gap-4 md:grid-cols-3">
                        {currentPackages.map((pkg) => (
                            <div key={pkg.id} className="border border-slate-200 rounded-lg p-4 flex items-center justify-between hover:border-[#0f5c52]/30 transition-colors bg-white">
                                <div>
